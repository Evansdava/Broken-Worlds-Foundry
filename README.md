...
2. Click the **Install System** button, and paste in this manifest link:
    * Foundry 0.5.x: [https://github.com/Evansdava/brokenworlds/raw/master/system.json](https://github.com/Evansdava/brokenworlds/raw/master/system.json)
...
All HTML, CSS, and JS is licensed under the [MIT license](https://github.com/Evansdava/brokenworlds/raw/master/LICENSE.txt).
...
In addition, the compendium content uses the OPEN GAME LICENSE Version 1.0a. See the [LICENSE-COMPENDIUM.txt](https://github.com/Evansdava/brokenworlds/raw/master/LICENSE-COMPENDIUM.txt) file for additional details.
